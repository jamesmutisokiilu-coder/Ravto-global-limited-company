...
# ==========================================
app = Flask(__name__)
app.secret_key = "ravto_secret_key"

# ==========================================
# DATABASE CONFIGURATION
# ==========================================
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///ravto.db'
...
def login():
    if request.method == 'POST':
        ...
        if user and check_password_hash(user.password, password):
            ...
            session['user_email'] = user.email   # ✅ FIXED
...
def admin_login():
    ...
    if request.method == 'POST':
        ...
        if request.form['username'] == "kutosi" and request.form['password'] == "extravaganza":
            session['admin'] = True
